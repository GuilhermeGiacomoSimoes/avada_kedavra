...
public class FragmentCharacterDetail extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        configButtonOK(binding.getRoot());
    ...
    private void configButtonOK(View view){
        view.findViewById(R.id.buttonOKCharacterDetail).setOnClickListener( new View.OnClickListener() {
            @Override
